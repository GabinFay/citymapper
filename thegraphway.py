...
class MainWindow(QMainWindow):
    ...
    def path_processing(self, G, path):
        ...
        # shortest_duration = nx.dijkstra_path_length(G, source=self.from_stop_i, target=self.to_stop_i, weight="duration_avg")/60
        print(f"Le temps sans tenir compte du temps d'attente est {duration//60} minutes")
